...
PostgreSQL-ready in prod. 218/218 integration assertions pass.
...
│  ├─ tests/                Integration test suite (218 assertions)
│  └─ requirements.txt
│
├─ libs/
...
python tests/test_backend.py                  # 218/218 assertions
```
