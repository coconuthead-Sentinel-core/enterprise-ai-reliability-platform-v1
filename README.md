...
PostgreSQL-ready in prod. 184/184 integration assertions pass.
...
│  ├─ tests/                Integration test suite (184 assertions)
│  └─ requirements.txt
│
├─ libs/
...
python tests/test_backend.py                  # 184/184 assertions
```
