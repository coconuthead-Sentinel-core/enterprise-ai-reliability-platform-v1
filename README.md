...
PostgreSQL-ready in prod. 152/152 integration assertions pass.
...
│  ├─ tests/                Integration test suite (152 assertions)
│  └─ requirements.txt
│
├─ libs/
...
python tests/test_backend.py                  # 152/152 assertions
```
