...
Completed on GitHub for commit `b29da3d9eaeedeae6ad64236c1a59b1961de1e8c`:

- PR CI checks are green.
- Release workflow run `24663922506` successfully built and pushed API and web images to GHCR.
